...
const DEFAULT_GAME_DATA = {
  ...
  game6: {
    1: ['찬양','찬양','찬양','찬양','찬양','찬양','찬양','찬양'],
    2: ['찬송','찬송','찬송','찬송','찬송','찬송','찬송','찬송'],
    3: ['찬양','찬양','찬송','찬송','찬송','찬송','찬양','찬양'],
    4: ['찬송','찬송','참외','찬양','찬양','참외','찬송','찬양'],
    5: ['참외','찬송','찬양','참외','찬송','찬양','찬송','참외']
  },
  game7: {
    1: ['땅끝','땅끝','땅끝','땅끝','땅끝','땅끝','땅끝','땅끝'],
    2: ['땅콩','땅콩','땅콩','땅콩','땅콩','땅콩','땅콩','땅콩'],
    3: ['땅끝','땅끝','땅콩','땅콩','땅콩','땅콩','땅끝','땅끝'],
    4: ['땅콩','땅콩','땅굴','땅끝','땅끝','땅굴','땅콩','땅끝'],
    5: ['땅굴','땅콩','땅끝','땅굴','땅끝','땅콩','땅굴','땅끝']
  },
  game8: {
    1: ['선교','선교','선교','선교','선교','선교','선교','선교'],
    2: ['성경','성경','성경','성경','성경','성경','성경','성경'],
    3: ['선교','선교','성경','성경','성경','성경','선교','선교'],
    4: ['성경','성경','성령','선교','선교','성령','성경','선교'],
    5: ['성령','성경','선교','성령','선교','성경','성령','성경']
  }
};
